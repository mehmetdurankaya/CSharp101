...
namespace static_class_ve_uyeler
{
	...
	{  
		static void Main(string[] args)
		{
			...
			Calisan calisan = new Calisan("Mehmet Duran", "Kaya", "IT");
			Calisan calisan2 = new Calisan("Ertuğrul", "Kaya", "IT");
			Calisan calisan3 = new Calisan("Nizamettin", "Kaya", "IT");
